...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        # Utilizing the Q-learning formula to update the Q-value
    ...
    def best_future_reward(self, state):
        ...
        # Return the maximum Q-value among all possible actions in the current state
        # max_future_reward = max(self.get_q_value(state, action) for action in actions)
